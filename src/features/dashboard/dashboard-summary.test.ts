...
it('counts completed attempts, valid checklist progress and unresolved work separately', () => {
  ...
  state.checklistProgress = [{ itemId: 'stock', date, status: 'done', updatedAt: at }, { itemId: 'expiry', date, status: 'needs_manager', updatedAt: at }, { itemId: 'missing', date, status: 'done', updatedAt: at }];
