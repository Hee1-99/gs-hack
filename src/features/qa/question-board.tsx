...
export function QuestionBoard() {
  ...
  return <div className={styles.board}><header className={styles.header}><div className="page-heading"><p className="eyebrow">필요할 때 바로 찾기</p><h1>매장 Q&A</h1><p>궁금한 업무를 물어보세요.<br/>매뉴얼에서 근거를 찾아 답해요.</p></div><div className={styles.headerIllustration} aria-hidden><MessagesSquare size={43} strokeWidth={1.8}/><span><Check size={18} strokeWidth={3}/></span></div></header>
