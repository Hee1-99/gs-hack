...
export function RoleShell({ role, children }: { role: 'crew' | 'manager'; children: React.ReactNode }) {
  ...
  return <div className="container workspace"><div className="role-bar"><span><strong>{manager ? '경영주 관리' : '스토어 매니저'}</strong></span><Link className="switch-role" href="/"><ArrowLeft size={15} aria-hidden/>시작 화면</Link></div>
